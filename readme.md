...
**OSD Clock** — это ультра-легкие цифровые часы для рабочего стола Windows, написанные на языке Go с использованием прямого обращения к системным библиотекам WinAPI (GDI/User32).
...
* **Прозрачность:** Черный цвет (`RGB 0,0,0`) зарезервирован системой как прозрачный фон. Не используйте черный цвет для текста.
